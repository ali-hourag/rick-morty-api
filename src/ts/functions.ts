...
import {
    removeLocationEventListener, setBreadcrumb, removeEpisodeSelected,
    removeCardCharacterContainerEventListener, removeEventListenersCardsEpisodes
...
function addCharacters(charactersURL: Array<string>): void {
    ...
    //Remove previous elements inside the container and its eventListener
 ...
 */
export async function episodeClicked(this: HTMLAnchorElement): Promise<void> {
    const episodeSection: (HTMLElement | null) = document.querySelector(".episode-info");
 ...
 */
export async function characterClicked(this: HTMLDivElement): Promise<void> {
...
function addEpisodesCS(episodesURL: Array<string>): void {
    ...
    //  Div container of the episodes in which a character has features in the character-info section
 ...
 */
export async function locationClicked(this: HTMLParagraphElement): Promise<void> {
